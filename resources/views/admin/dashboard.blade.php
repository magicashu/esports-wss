...
<head>
	...
	<!-- Theme JS files -->
	<script src="plugins\tables\footable\footable.min.js"></script>

    <script src="js\app.js"></script>
	<script src="demo_pages\table_responsive.js"></script>
	<!-- /theme JS files -->
          ...
          Here are the results from the matches.
					...
					<table class="table table-togglable table-hover">
						<thead>
							<tr>
								<th data-toggle="true">Username</th>
								<th data-hide="phone">Team Selected</th>
								<th data-hide="phone,tablet">Goals</th>
								<th data-hide="phone,tablet" data-name="Date Of Birth">Red Card & Fouls</th>
								<th data-hide="phone" data-ignore="true">Points</th>
								<th class="text-center" style="width: 30px;"><i class="icon-menu-open2"></i></th>
							</tr>
						</thead>
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						This table will show the game going on and the the leader board kills deaths K/D ratio Points earned.
                        Money earned Will be displayed at the end of the game
                        1 kill = X points.
					</div>
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								<button class="add-button" style="background-color:green; padding-left:10vh;"type="submit">
        							Add
      						</button>
							</tbody>
							</div>
				...
				<div class="card">
					...
					<div class="card-body">
						Table for Fifa Every goal cards fouls count. 1 goal = X point
						</div>
					...
					<table class="table table-togglable table-hover">
						<thead>
							<tr>
								<th data-toggle="true">Username</th>
								<th data-hide="phone">Team selected</th>
								<th data-hide="phone,tablet">Total Goals</th>
								<th data-hide="phone,tablet">Red Cards?</th>
								<th data-hide="phone">Fouls</th>
						...
						<button class="add-fifa" style="background-color:green; "type="submit">
        							Add
      						</button>
							<!-- <tr>
								<td>Marth</td>
